...
function SongEnded(io, socket) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let nextSong = [];
            const value = (yield (0, utils_1.getCurrentlyPlaying)(roomInfo._id, userInfo === null || userInfo === void 0 ? void 0 : userInfo.id))[0];
            yield queueModel_1.default.updateOne({ roomId: roomInfo._id, isPlaying: true }, {
                isPlaying: false,
            }),
                (nextSong = yield (0, utils_1.getCurrentlyPlaying)(roomInfo === null || roomInfo === void 0 ? void 0 : roomInfo._id, userInfo === null || userInfo === void 0 ? void 0 : userInfo.id, false));
            if ((nextSong === null || nextSong === void 0 ? void 0 : nextSong.length) == 0) {
                nextSong = yield (0, utils_1.getSongByOrder)(roomInfo === null || roomInfo === void 0 ? void 0 : roomInfo._id, value.order);
            }
